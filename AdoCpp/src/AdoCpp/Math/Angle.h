...
namespace AdoCpp
{
    ...
    private:
        friend constexpr Angle degrees(double angle);
        friend constexpr Angle radians(double angle);

        ////////////////////////////////////////////////////////////
        /// \brief Construct from a number of radians
        ///
        /// This function is internal. To construct angle values,
        /// use `AdoCpp::radians` or `AdoCpp::degrees` instead.
        ///
        ...
        // Member data
        ////////////////////////////////////////////////////////////
        double m_degrees{}; //!< Angle value stored as degrees
    };
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] constexpr Angle degrees(double angle);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] constexpr Angle radians(double angle);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] constexpr Angle operator*(Angle left, double right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] constexpr Angle operator*(double left, Angle right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] constexpr double operator/(Angle left, Angle right);
    ...
    /// Examples:
    /// \code
    /// AdoCpp::degrees(90) % AdoCpp::degrees(40)  // 10 degrees
    /// AdoCpp::degrees(-90) % AdoCpp::degrees(40) // 30 degrees (not -10)
    /// \endcode
    ///
    /// \param left  Left operand (an angle)
    /// \param right Right operand (an angle)
